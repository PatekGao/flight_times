...
# file config
CURRENT_STATUS_FILE = "2024_现状_WUH.xlsx"
ARR_HOURLY_STATS_FILE = "到达航班比例表-new.xlsx"
DEP_HOURLY_STATS_FILE = "出发航班比例表-new.xlsx"
PAIRING_FILE = "final_pairing_processed_WUH.xlsx"
